...
export const fallbackMockQuizzes: QuizData[] = [
  ...
  },
  {
    ...
    questions: [
      ...
      { id: "q2_8", type: "short_answer", weight: 1, questionText: "Tuliskan romaji dari hiragana 'ねこ' (huruf kecil semua).", correctAnswerText: "neko" },
  ...
  },
  {
    ...
    questions: [
      { id: "q3_1", type: "multiple_choice", weight: 1, questionText: "Partikel apa yang sering digunakan semata-mata untuk menandai subjek topik dalam sebuah kalimat?", options: [{ text: "を (o)" }, { text: "に (ni)" }, { text: "は (wa)" }, { text: "で (de)" }], correctOptionIndex: 2 },
